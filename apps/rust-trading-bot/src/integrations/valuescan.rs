...
/// 从 V2 转换为 V1 格式(向后兼容)
impl From<TradingSignalV2> for crate::ai_core::deepseek::TradingSignal {
    fn from(v2: TradingSignalV2) -> Self {
        crate::ai_core::deepseek::TradingSignal {
            signal: v2.signal,
...
impl From<PositionManagementDecisionV2> for crate::ai_core::deepseek::PositionManagementDecision {
    fn from(v2: PositionManagementDecisionV2) -> Self {
        crate::ai_core::deepseek::PositionManagementDecision {
            action: v2.action,
            ...
            stop_loss_adjustment: v2.new_stop_loss.map(|price| {
                crate::ai_core::deepseek::StopLossAdjustment {
                    should_adjust: true,
