...
// TODO: PositionDecision type does not exist - needs implementation
use crate::ai_core::ai_trait::PositionDecision;
...
pub struct PositionCoordinator {
    ...
    last_ai_decisions: Arc<RwLock<HashMap<String, PositionDecision>>>,
}
...
impl PositionCoordinator {
    ...
    pub async fn merge_decisions_to_plan(
        &self,
        ai_decisions: Vec<PositionDecision>,
        leverage: u32,
    ) -> Vec<TradeAction> {
    ...
    fn handle_opposite_direction(
        ...
        warn!(
            "🔄 {} 高信心反向信号，准备反手: {}",
            decision.symbol, "Legacy code - needs PositionDecision field mapping"
        );
